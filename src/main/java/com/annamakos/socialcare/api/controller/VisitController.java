...
public class VisitController {
    ...
    @RequestMapping(value = "/visits/{username}", method = RequestMethod.GET)
    public ResponseEntity<List<VisitDTO>> findVisitsByUser(@PathVariable String username) {
        List<VisitDTO> visits = this.visitService.findAllByUserName(username);
        return new ResponseEntity<>(visits, HttpStatus.OK);
    }
