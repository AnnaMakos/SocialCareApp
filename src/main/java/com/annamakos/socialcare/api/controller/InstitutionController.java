...
public class InstitutionController {
    ...
    public ResponseEntity<InstitutionDTO> findInstitutionById(@PathVariable int id) {
        InstitutionDTO institutionDTO = this.institutionService.findInstitutionDTOById(id);
